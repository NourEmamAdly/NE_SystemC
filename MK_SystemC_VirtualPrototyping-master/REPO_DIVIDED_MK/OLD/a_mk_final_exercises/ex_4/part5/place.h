...
class place : public placeInterface          //<T>
{
    ...
    public:
        place(unsigned int initialNumberOfTokens=16) : tokens(initialNumberOfTokens)                        // 16 is a default size. The initial number of tokens should be passed as a parameter to the constructor and then set in the constructor of the channel place.
        {
        }
